...
// let playBtn = document.getElementById('player__start');
// let playBtnStart = document.getElementById('player__button-start');
// let svgIcon = $('.icon-play');
// let btnPaused = $('.player__start');
// let volumeControl = $('.player__playsound');
// let playTime = $('.player__duratipn-completed');
